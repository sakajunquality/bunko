...
if (import.meta.main) {
  ...
  const result = await setup({ verifyAttestation: process.env.INPUT_VERIFY_ATTESTATION === "true", version: process.env.INPUT_VERSION ?? "v0.1.0-rc.3", repository: process.env.INPUT_REPOSITORY,
