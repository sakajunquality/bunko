...
import { createGunzip, createZstdDecompress, constants } from "node:zlib";
...
export async function decodeLayer(store: BlobStore, d: Descriptor, diffId: Digest, output?: string, maxBytes = 2 * 1024 ** 3): Promise<void> {
