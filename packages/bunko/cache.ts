...
export class LayerCache {
  ...
  private validate(input: unknown, key: Digest, kind: "deps" | "assets" | "app", expected?: { destination: string; platform: Platform | null; application?: { locations?: LocationDiagnostics; entry: string; entrypoints: Record<string, string> } }): CacheRecord {
  ...
  async get(key: Digest, kind: "deps" | "assets" | "app", bypass = false, expected?: { destination: string; platform: Platform | null; application?: { locations?: LocationDiagnostics; entry: string; entrypoints: Record<string, string> } }): Promise<CacheRecord | undefined> {
