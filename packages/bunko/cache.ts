...
/** `base` records the base-inspection lookup, which is metadata-only and has no cache layer. */
export interface CacheEvent { kind: "deps" | "assets" | "app" | "runtime" | "base"; key: Digest; status: "local" | "registry" | "miss" | "bypass"; source?: string; reason?: "disabled" | "not-found" | "invalid-or-unavailable" }
