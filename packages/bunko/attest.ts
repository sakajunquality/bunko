    ...
    predicateType: "https://slsa.dev/provenance/v1", predicate: {
      buildDefinition: { buildType: "https://github.com/sakajunquality/bunko/build/v1",
        ...
        internalParameters: { builder: result.builder }, resolvedDependencies: [dependency("urn:bunko:source", result.sourceDigest),
          ...
          ...result.images.flatMap((image) => image.runtime ? [dependency(image.runtime.url, image.runtime.archiveDigest), { ...dependency(image.runtime.url.replace(/\/[^/]+$/, "/SHASUMS256.txt.asc"), image.runtime.checksumDocumentDigest), annotations: { signer: image.runtime.signer, policy: image.runtime.policy } }] : []),
