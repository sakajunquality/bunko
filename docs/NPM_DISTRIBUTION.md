...
The current stable release is **0.11.0**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.11.0.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.11.0 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.11.0
bunko version
```
...
```sh
gh release download v0.11.0 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=9caa1c3b086be9eaea779dec525e5f5e9356920e \
  bun scripts/verify-release.ts dist/release v0.11.0
bun scripts/npm-package.ts dist/release dist/npm v0.11.0
