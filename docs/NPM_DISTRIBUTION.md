...
```sh
bunx @sakajunquality/bunko@0.1.4 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.1.4
bunko version
```
...
```sh
gh release download v0.1.4 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=c521995c68d10c6e5a0d87d9933b0486209f7b70 \
  bun scripts/verify-release.ts dist/release v0.1.4
bun scripts/npm-package.ts dist/release dist/npm v0.1.4
