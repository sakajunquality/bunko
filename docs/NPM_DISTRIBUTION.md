...
The current stable release is **0.12.4**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.12.4.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.12.4 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.12.4
bunko version
```
...
```sh
gh release download v0.12.4 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=f3b5b66758b725b1eb793237f5fa3f75ebc01a41 \
  bun scripts/verify-release.ts dist/release v0.12.4
bun scripts/npm-package.ts dist/release dist/npm v0.12.4
