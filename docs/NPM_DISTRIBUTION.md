...
The current stable release is **0.12.0**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.12.0.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.12.0 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.12.0
bunko version
```
...
```sh
gh release download v0.12.0 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=77b4116069e1853439ca1b2e00a8e7d2a0aa00e0 \
  bun scripts/verify-release.ts dist/release v0.12.0
bun scripts/npm-package.ts dist/release dist/npm v0.12.0
