...
The current stable release is **0.12.3**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.12.3.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.12.3 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.12.3
bunko version
```
...
```sh
gh release download v0.12.3 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=e2cd9359d6c49d1f6de30a6c8faf339455c36e6a \
  bun scripts/verify-release.ts dist/release v0.12.3
bun scripts/npm-package.ts dist/release dist/npm v0.12.3
