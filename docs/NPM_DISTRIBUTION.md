...
The current stable release is **0.1.3**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.1.3.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.1.3 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.1.3
bunko version
```
...
```sh
gh release download v0.1.3 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=329286645a118d5c7a4f468c98fc3f970dc1c40c \
  bun scripts/verify-release.ts dist/release v0.1.3
bun scripts/npm-package.ts dist/release dist/npm v0.1.3
