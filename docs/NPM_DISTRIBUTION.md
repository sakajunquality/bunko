...
The current stable release is **0.12.2**, published through GitHub Actions trusted publishing with npm provenance. See [stable publication evidence](validation/v0.12.2.md).

Usage:

```sh
bunx @sakajunquality/bunko@0.12.2 version
bunx @sakajunquality/bunko@latest build .
npm install -g @sakajunquality/bunko@0.12.2
bunko version
```
...
```sh
gh release download v0.12.2 --repo sakajunquality/bunko --dir dist/release
BUNKO_ATTESTATION_SOURCE_DIGEST=ce3f6d3c88c32a73f2c7593b2610566c12c51f8a \
  bun scripts/verify-release.ts dist/release v0.12.2
bun scripts/npm-package.ts dist/release dist/npm v0.12.2
