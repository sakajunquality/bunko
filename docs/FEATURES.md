...
The [release notes](RELEASE_NOTES.md) describe the current alpha candidate. Validation reports identify their tested revisions, fixture scope and environments; a historical passing result is not a claim that every provider or workload is supported.
