...
This proposal tracks #220, #223 and #229. The current patch improves diagnostics and prevents pruning a closure plan solely because its packing fingerprint belongs to another CLI. Cross-version cache reuse and safe residue reclamation remain follow-ups. New-format lock recovery is implemented as described below.
