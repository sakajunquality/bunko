...
| Base updates | Explicit selection, checks, [safe rebase](REBASE.md), and [base assessment / acceptance-gated tags](REBASE_OPERATIONS.md) | Requires build ownership metadata and identical files or an explicit ABI contract; native library updates require rebuilding |
