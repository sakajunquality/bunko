...
This establishes the GitHub Actions provider and staging service paths. It does not certify public production services, Buildkite, Google ambient credentials, or every custom Sigstore deployment. Staging trust material and service availability can change; review the configured trust before rerunning.
