...
GitHub, Google, Podman and local login/logout shipped in bunko v0.9.0. Native AWS authentication shipped in v0.10.0 after #198 passed [private ECR acceptance](aws-registry-credentials.md), including native GitHub OIDC and environment-session paths. Deployed EKS identities, EC2 IMDSv2 and ECR Public remain unverified.

## Original v0.9.0 acceptance on September 16, 2026
