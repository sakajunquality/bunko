...
The current container recipe packages the published, checksum-verified JavaScript CLI with pinned Bun 1.4.2, GnuPG's `gpgv`, Git and CA certificates. The published 0.5.0 reference is `ghcr.io/sakajunquality/bunko:v0.5.0`, with verified multiarchitecture index `sha256:822568df340c3491ab69635bdf7d63b8a315a75443c16fed7a62e62e2425581f`. This recipe supports Bun lockfile v2. Pin the published index digest for reproducible consumption. Container publication and source release publication are separate operations.
...
docker run --rm --read-only --cap-drop=ALL --security-opt=no-new-privileges \
  ...
  ghcr.io/sakajunquality/bunko@sha256:822568df340c3491ab69635bdf7d63b8a315a75443c16fed7a62e62e2425581f \
