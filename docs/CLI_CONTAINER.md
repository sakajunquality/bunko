...
The current container recipe packages the published, checksum-verified JavaScript CLI with pinned Bun 1.4.2, GnuPG's `gpgv`, Git and CA certificates. The published 0.12.5 reference is `ghcr.io/sakajunquality/bunko:v0.12.5`, with verified multiarchitecture index `sha256:471715f3e0c88b845247f06187b5c241f16944c0e15154694844f28c3e1d5562`. This recipe supports Bun lockfile v2. Pin the published index digest for reproducible consumption. Container publication and source release publication are separate operations.
...
docker run --rm --read-only --cap-drop=ALL --security-opt=no-new-privileges \
  ...
  ghcr.io/sakajunquality/bunko@sha256:471715f3e0c88b845247f06187b5c241f16944c0e15154694844f28c3e1d5562 \
...
[Container workflow 34812832551](https://github.com/sakajunquality/bunko/actions/runs/34812832551) validated, attested and promoted index `sha256:96a39d371765f758f67db34ffdaeb97b9138d928c0c856b82ca51161086fefc6` from recipe source `46accad26dffa92ab039031a3301ef24ea9f80ff`. Independent exact-source attestation verification, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match the GitHub v0.8.1 release. See [release evidence](validation/v0.8.1.md).

## v0.8.2 publication

[Container workflow 34851079124](https://github.com/sakajunquality/bunko/actions/runs/34851079124) validated, attested and promoted index `sha256:5a88d47ee434ae70db4ff8dab40c02ebe8a654931be5b62f67cf8fa2d5dfa401` from recipe source `5a52fb58c1c370cbd276eedcee2bb730942034b4`. Independent exact-source attestation verification, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match the GitHub v0.8.2 release. See [release evidence](validation/v0.8.2.md).
...
[Container workflow 35177955862](https://github.com/sakajunquality/bunko/actions/runs/35177955862) validated, attested and promoted index `sha256:a90e6a5b8916b91e766dab1acb840d50991c6f2f84cdfab1a1a8728940f07059` from recipe source `9caa1c3b086be9eaea779dec525e5f5e9356920e`. Independent exact-source attestation verification, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match GitHub v0.11.0. See [release evidence](validation/v0.11.0.md).

## v0.12.0 publication

[Container workflow 35193164734](https://github.com/sakajunquality/bunko/actions/runs/35193164734) validated, attested and promoted index `sha256:7471b3afbd13e2ae51bdaf27d61a9d77b88f514f3bee45a7088440f4f25aa437` from recipe source `77b4116069e1853439ca1b2e00a8e7d2a0aa00e0`. Independent exact-source attestation verification, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match GitHub v0.12.0. See [release evidence](validation/v0.12.0.md).

## Explicit native registry authentication

These options are available in v0.10.0 and later. Pin the current verified container digest for reproducible use.
...
For the Kubernetes Job example, retain the nonroot/read-only security settings and writable temporary/cache volumes. Use the reviewed v0.12.5 digest shown above. For GKE, configure `serviceAccountName` for workload identity and replace the args with:
...
[Container workflow 35305646230](https://github.com/sakajunquality/bunko/actions/runs/35305646230) validated, attested and promoted index `sha256:02cee62eed8c117ece5f3f31240c6272935fe3b776986d8c82bbbb31c2ad5765` from recipe source `e2cd9359d6c49d1f6de30a6c8faf339455c36e6a`. Independent exact-source attestation, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match GitHub v0.12.3. See [release evidence](validation/v0.12.3.md).

## v0.12.5 publication

[Container workflow 35444675635](https://github.com/sakajunquality/bunko/actions/runs/35444675635) validated, attested and promoted index `sha256:471715f3e0c88b845247f06187b5c241f16944c0e15154694844f28c3e1d5562` from recipe source `2ed0b81b03bfcc960631dc83c8fa6c324e68dd9a`. Independent exact-source attestation, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match GitHub v0.12.5. See [release evidence](validation/v0.12.5.md).

## v0.12.4 publication

[Container workflow 35313903638](https://github.com/sakajunquality/bunko/actions/runs/35313903638) validated, attested and promoted index `sha256:4819a5bc95248421f13a8d48ee42212fe97bce0951ff9192c6c69346cd0eafa1` from recipe source `f3b5b66758b725b1eb793237f5fa3f75ebc01a41`. Independent exact-source attestation, anonymous pulls and nonroot/read-only/network-disabled execution passed on amd64 and arm64. Both in-image CLI hashes match GitHub v0.12.4. See [release evidence](validation/v0.12.4.md).
