...
Compile mode and runtime injection additionally require `gpgv` and a pinned official Bun revision. Development builds support official Bun 1.3.13 and 1.4.2 for these modes. Published v0.10.0 also supports 1.4.0/1.4.1; published 0.1.4 remains available for 1.3.11/1.3.12.
