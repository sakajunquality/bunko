...
Download `bunko.js`, `SHA256SUMS`, `LICENSE`, `THIRD_PARTY_NOTICES.md`, and `PROVENANCE.jsonl` from the [v0.8.3 release](https://github.com/sakajunquality/bunko/releases/tag/v0.8.3) into the same directory. Install Bun 1.4.2 (or another supported version), then verify the files before running the CLI:
