...
import { classifyAddon, dependencyInputs, dependencyPlan, inspectELF, installDependencies, runtimeEntries, validateLock, type DependencyPlan } from "../packages/bunko/deps.ts";
